...
const Watch = () => {
  ...
  return (
    <div className="min-h-screen bg-background">
      ...
      <main className="pt-14 lg:hidden flex flex-col h-[calc(100vh-3.5rem)]">
        {/* Fixed Video Section */}
            ...
            <div className="flex items-center justify-between mt-2">
              ...
              <div className="flex items-center gap-1">
                ...
                <button
                  ...
                  className="flex items-center gap-1 px-3 py-1.5 bg-primary text-primary-foreground hover:bg-primary/90 transition-colors text-xs font-medium rounded-full"
                  aria-label="PDF"
                >
                  <FileText size={14} />
                  <span>PDF</span>
            ...
            <div className="p-4">
              ...
              <div className="mt-4">
                ...
                <div className="flex items-center gap-3 mt-4">
                  ...
                  <button onClick={handlePdfOpen} className="control-button bg-primary text-primary-foreground hover:bg-primary/90">
                    <FileText size={18} />
                    <span>PDF</span>
                  </button>
                </div>
